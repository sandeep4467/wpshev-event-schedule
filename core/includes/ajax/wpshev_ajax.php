...

{
...

  {
...

    {
      ...
      if ($_POST['started_by'] == 'instructor') {
          $update = $wpdb->update($wpdb->prefix . 'instructor_data', array(
            'start_date' => current_time('mysql') ,
  ...
  public function add_payment(){
    ...
    $payments = wpshevManagePayment::get_payments($_POST['instructor_id'], $_POST['month_year']);

    //die(var_dump($payments));

    $payment_due_date = $payments[0]->payment_due_date;


    $table = $wpdb->prefix . 'instructor_payment_data';
    $insert = $wpdb->insert( 
      $table, 
      array( 
        'job_id' => 0, 
        ...
        'access_limited_time_type' => '',
        'access_limited_time_value' => 0,
        'bill_cycle' => $_POST['payment_cycle'],
        'monthly_payment' => $_POST['amount'],
        'plan_price' => 0,
        'level_id' => 0,
        'status' => $_POST['status'],
        'is_job_running' => 1,
